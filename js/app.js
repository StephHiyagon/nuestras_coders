window.addEventListener("DOMContentLoaded",function(){
  ...
  var coders=[{nombre: "Fiorella Quispe"},{nombre:"Lourdes Vilchez"},{nombre:"Rossmery Maldonado"},{nombre:"Yessenia Huaman"},{nombre:"Miriam Mendoza"},{nombre:"Elizabeth Condori"}];
